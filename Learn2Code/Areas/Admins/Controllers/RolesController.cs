...
namespace Learn2Code.Areas.Admins.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        public RolesController(W3studyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Roles != null ? 
                          ...
                          Problem("Entity set 'W3studyContext.Roles'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Idrole,NameRole,Description")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idrole,NameRole,Description")] Role role)
        {
            if (id != role.Idrole)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'W3studyContext.Roles'  is null.");
            }
            var role = await _context.Roles.FindAsync(id);
            if (role != null)
            {
